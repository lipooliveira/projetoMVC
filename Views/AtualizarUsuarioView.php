    ...
    <div class="container mt-3">
        ...
        <form action="<?php echo BASE_URL?>/Usuario/editar" method="POST">
            ...
            <div class="form-group">
                  <input type="text" class="form-control" id="cpf" name="cpf" pattern="\d{3}\.\d{3}\.\d{3}-\d{2}" title="O CPF deve estar no formato xxx.xxx.xxx-xx" value="<?php echo $usuario->getCpf()?>" required disabled>
            </div>
            <div class="form-group">
                <label for="nome">Nome:</label>
                <input type="text" class="form-control" id="nome" name="nome" value="<?php echo $usuario->getNome()?>" required disabled>
            </div>
            <div class="form-group">
                <label for="data_nascimento">Data de Nascimento:</label>
                <input type="date" class="form-control" id="data_nascimento" name="data_nascimento" value="<?php echo $usuario->getDataNascimento()?>" required disabled>
            </div>
            <div class="form-group">
                <label for="nome_mae">Nome da Mãe:</label>
                <input type="text" class="form-control" id="nome_mae" name="nome_mae" value="<?php echo $usuario->getNomeMae()?>" required disabled>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="login" name="login" pattern="^[a-zA-Z]{6}$" title="O login deve ter 6 caracteres alfabéticos" value="<?php echo $usuario->getLogin()?>" required disabled>
            </div>
            <div class="form-group">
